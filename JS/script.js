...
window.addEventListener("scroll", function () {
    ...
    // Toggles Fixed Class In Navbar On Scrolling
...
let signImg = document.querySelector('#signImg');

// Menu btn
menuBtn.onclick = function () {
    // Toggles Active Class In Nav Items On Click
    document.querySelector(".nav-items").classList.toggle("active");
    // Changes Icons on Click
...
darkBtn.onclick = function () {
    ...
    if (document.body.classList.contains('dark-mode')) {
        ...
        // Changes Darks Mode Button Icon
...
menuTabs.addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("menu-tab-item") && !e.target.classList.contains('active')) {
        ...
        // Removes Show Class Form Active Tab Content
